...
Arrow to the Build **v3.0.0** uses one semantic color engine for built-in and user-created themes. The in-app Theme Editor and hand-edited JSON files are two interfaces to the same format.
