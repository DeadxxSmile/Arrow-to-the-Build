...
The default folder is `Documents\Arrow to the Build\Builds`; it can be changed under Settings → Build Editor. If a file was changed outside the app, ATTB keeps that version rather than overwriting it.
