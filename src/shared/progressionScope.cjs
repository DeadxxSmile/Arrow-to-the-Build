...
const STARTING_POINTS = Object.freeze(['new_character', 'level_50', 'cp160_plus'])
const DEFAULT_PROGRESSION_SCOPE = Object.freeze({
...
function resolveProgressionScope(input) {
...
function scopeForStartingPoint(startingPoint, description = '') {
...
function inferStartingPoint({ level = 1, championPoints = 0 } = {}) {
